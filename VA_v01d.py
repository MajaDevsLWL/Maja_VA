...
if __name__ == "__main__":
    ...
    while True:        
        ...
        if 'nie dziękuję' in query:
            speak("Dziękuję za skorzystanie z mojej pomocy, do zobaczenia")
            sys.exit()
            ...
            speak("Co mam odszukać?")
            cm = takeCommand().lower()
            kit.search(f"{cm}")
            speak(f"Szukam w google {cm}")
        ...
        speak("Czy mogę w czyś jeszcze pomóc?")
