    ...
    while True:        
        ...
        if 'nie dziękuję' in query or "papa" in query or "do widzenia" in query or "wyłącz się" in query:
            ...
            try:
                ...
                speak("Nie udało mi się znależć żadnych informacji o tej osobie")
            ...
            speak("Twarzoksiążka została otwarta")
            ...
            speak("Proszę wpisać poprawną nazwę urzytkownika instagrama")
            name = input("Wpisz nazwę użutkownika tutaj:")
            webbrowser.open(f"www.instagram.com/{name}")
            speak(f"Oto profil użytkowniak {name} na instagramie")
            time.sleep(3)
        ...
        elif "przygłoś" in query or "podgłoś" in query or "podgłośnij" in query:
            pyautogui.press("volumeup")
            
        elif "przycisz" in query or "ścisz" in query:
        ...
        '''elif "temperatura" in query:
            ...
            r = requests.get(url)
            data = BeautifulSoup(r.text,"html.parser")
            temp = data.find("div",class_="vk_bk TylWce").text
